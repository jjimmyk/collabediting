-- Add Daniel and Nicolle as default Incident Commanders on every workspace (idempotent)
...
select public.sync_default_roster_user('daniel.dunn190@gmail.com');
select public.sync_default_roster_user('nicolle.bogden@disastertech.com');
