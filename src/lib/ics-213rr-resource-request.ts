...
export const DEFAULT_ICS213RR_RESOURCE_REQUESTS: ResourceRequestItem[] = [
  {
    ...
    status: 'Pending',
    incidentName: 'Hurricane EDGAR — Gulf of Mexico Offshore Response',
    dateTimeInitiated: '05/09/2026 07:30',
    requestNumber: 'RR-2026-0142',
    orderQuantity: 2,
    orderKind: 'Aircraft',
    orderType: 'Offshore Personnel Evacuation',
    orderPriority: 'U',
    orderDetailedDescription:
      'Additional S-92 helicopter sorties for phased non-essential personnel evacuation from Mad Dog and Atlantis ahead of Hurricane EDGAR landfall window.',
    orderRequestedReportingLocation: 'PHI Houma heliport — BP aviation coordinator',
    orderLocationDateTime: '05/09/2026 12:00 CST',
    orderNumberLsc: '',
    orderEtaLsc: '',
    orderCostLsc: '',
    suggestedSourcesAndSubstitutes:
      'PHI Aviation primary; Bristow Gulf of Mexico roster as substitute if PHI capacity constrained.',
    requestedByName: 'Capt. R. Delacroix',
    requestedByPosition: 'BP Aviation Coordinator',
    requestedByDateTime: '05/09/2026 07:30 CST',
    ...
    notes: 'Coordinate with Mad Dog OIM before final evacuation manifest.',
  ...
  },
  {
    ...
    orderPriority: 'R',
    orderDetailedDescription:
      'Additional mobile command post for Port Fourchon forward staging area communications redundancy.',
    orderRequestedReportingLocation: 'Port Fourchon BP logistics staging',
    orderLocationDateTime: '05/09/2026 14:00 CST',
    orderNumberLsc: '',
    orderEtaLsc: '',
    orderCostLsc: '',
    suggestedSourcesAndSubstitutes:
      'BP Houston crisis center virtual bridge; existing unified command footprint may satisfy requirement.',
    requestedByName: 'M. Patel',
    requestedByPosition: 'Finance/Administration Section Chief',
    requestedByDateTime: '05/09/2026 08:00 CST',
    sectionChiefApprovalName: 'M. Hartman',
    sectionChiefApprovalPosition: 'Unified Command Incident Commander',
    sectionChiefApprovalSignature: 'M. Hartman',
    ...
    requisitionPurchaseOrderNumber: '',
    supplierNamePhoneFaxEmail: '',
    notes: 'Request superseded by BP Westlake unified command bridge; alternate comms plan approved.',
    logisticsApprovalName: '',
    logisticsApprovalPosition: '',
    logisticsApprovalSignature: '',
    logisticsApprovalDateTime: '',
