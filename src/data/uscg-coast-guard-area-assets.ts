...
export const USCG_COAST_GUARD_AREA_ASSETS: Record<UscgCoastGuardAreaKey, ResourceListItemData[]> = {
  atlantic: [
    {
      id: 101,
      name: 'CGC Forward',
...
export function filterCoastGuardAreaAssets(
  ...
  const assets = USCG_COAST_GUARD_AREA_ASSETS[areaKey]
