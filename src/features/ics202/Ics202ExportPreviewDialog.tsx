...
import type { Ics202DocxBlock } from '@/features/ics202/export'

type Ics202ExportPreviewDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  title: string
  blocks: Ics202DocxBlock[]
  onExportWord: () => void
  onExportPdf: () => void
}
      ...
      <DialogContent className="!w-[70vw] !max-w-[70vw] sm:!max-w-[70vw]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Placeholder rendering of the ICS-202 export. Layout, fonts, and pagination will differ
