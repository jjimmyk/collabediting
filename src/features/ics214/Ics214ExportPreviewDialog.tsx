...
import type { Ics214DocxBlock } from '@/features/ics214/export'

type Ics214ExportPreviewDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  title: string
  blocks: Ics214DocxBlock[]
  onExportWord: () => void
  onExportPdf: () => void
}

export function Ics214ExportPreviewDialog({
  open,
  onOpenChange,
  title,
  blocks,
  onExportWord,
  onExportPdf,
}: Ics214ExportPreviewDialogProps) {
  return (
      ...
      <DialogContent className="!w-[70vw] !max-w-[70vw] sm:!max-w-[70vw]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Placeholder rendering of the ICS-214 export. Layout, fonts, and pagination will differ
