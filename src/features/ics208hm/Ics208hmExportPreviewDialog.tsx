...
import type { Ics208hmDocxBlock } from '@/features/ics208hm/export'

type Ics208hmExportPreviewDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  title: string
  blocks: Ics208hmDocxBlock[]
  onExportWord: () => void
  onExportPdf: () => void
}

export function Ics208hmExportPreviewDialog({
  open,
  onOpenChange,
  title,
  blocks,
  onExportWord,
  onExportPdf,
}: Ics208hmExportPreviewDialogProps) {
  return (
      ...
      <DialogContent className="!w-[70vw] !max-w-[70vw] sm:!max-w-[70vw]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Placeholder rendering of the ICS-208HM export. Layout, fonts, and pagination will differ
