...
import type { Ics205DocxBlock } from '@/features/ics205/export'

type Ics205ExportPreviewDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  title: string
  blocks: Ics205DocxBlock[]
  onExportWord: () => void
  onExportPdf: () => void
}

export function Ics205ExportPreviewDialog({
  open,
  onOpenChange,
  title,
  blocks,
  onExportWord,
  onExportPdf,
}: Ics205ExportPreviewDialogProps) {
  return (
      ...
      <DialogContent className="!w-[70vw] !max-w-[70vw] sm:!max-w-[70vw]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Placeholder rendering of the ICS-205 export. Layout, fonts, and pagination will differ
