...
import type { Ics206DocxBlock } from '@/features/ics206/export'

type Ics206ExportPreviewDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  title: string
  blocks: Ics206DocxBlock[]
  onExportWord: () => void
  onExportPdf: () => void
}

export function Ics206ExportPreviewDialog({
  open,
  onOpenChange,
  title,
  blocks,
  onExportWord,
  onExportPdf,
}: Ics206ExportPreviewDialogProps) {
  return (
      ...
      <DialogContent className="!w-[70vw] !max-w-[70vw] sm:!max-w-[70vw]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Placeholder rendering of the ICS-206 export. Layout, fonts, and pagination will differ
