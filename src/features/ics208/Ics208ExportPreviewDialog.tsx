...
import type { Ics208DocxBlock } from '@/features/ics208/export'

type Ics208ExportPreviewDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  title: string
  blocks: Ics208DocxBlock[]
  onExportWord: () => void
  onExportPdf: () => void
}

export function Ics208ExportPreviewDialog({
  open,
  onOpenChange,
  title,
  blocks,
  onExportWord,
  onExportPdf,
}: Ics208ExportPreviewDialogProps) {
  return (
      ...
      <DialogContent className="!w-[70vw] !max-w-[70vw] sm:!max-w-[70vw]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Placeholder rendering of the ICS-208 export. Layout, fonts, and pagination will differ
