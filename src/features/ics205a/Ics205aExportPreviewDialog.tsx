...
import type { Ics205aDocxBlock } from '@/features/ics205a/export'

type Ics205aExportPreviewDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  title: string
  blocks: Ics205aDocxBlock[]
  onExportWord: () => void
  onExportPdf: () => void
}

export function Ics205aExportPreviewDialog({
  open,
  onOpenChange,
  title,
  blocks,
  onExportWord,
  onExportPdf,
}: Ics205aExportPreviewDialogProps) {
  return (
      ...
      <DialogContent className="!w-[70vw] !max-w-[70vw] sm:!max-w-[70vw]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Placeholder rendering of the ICS-205A export. Layout, fonts, and pagination will differ
