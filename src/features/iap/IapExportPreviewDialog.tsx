...
import type { IapDocxBlock } from '@/features/iap/export'

type IapExportPreviewDialogProps = {
  open: boolean
...
export function IapExportPreviewDialog({
  open,
  onOpenChange,
  title,
  blocks,
      ...
      <DialogContent className="!w-[70vw] !max-w-[70vw] sm:!max-w-[70vw]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Placeholder rendering of the IAP export. Layout, fonts, and pagination will differ in
