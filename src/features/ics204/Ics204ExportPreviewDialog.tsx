...
import type { Ics204DocxBlock } from '@/features/ics204/export'

type Ics204ExportPreviewDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  title: string
  blocks: Ics204DocxBlock[]
  onExportWord: () => void
  onExportPdf: () => void
}
      ...
      <DialogContent className="!w-[70vw] !max-w-[70vw] sm:!max-w-[70vw]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Placeholder rendering of the ICS-204 export. Layout, fonts, and pagination will
            differ in the final Word or PDF file.
          </DialogDescription>
        </DialogHeader>
