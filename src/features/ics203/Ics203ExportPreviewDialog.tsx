...
import type { Ics203DocxBlock } from '@/features/ics203/export'

type Ics203ExportPreviewDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  title: string
  blocks: Ics203DocxBlock[]
  onExportWord: () => void
  onExportPdf: () => void
}

export function Ics203ExportPreviewDialog({
  open,
  onOpenChange,
  title,
  blocks,
  onExportWord,
  onExportPdf,
}: Ics203ExportPreviewDialogProps) {
  return (
      ...
      <DialogContent className="!w-[70vw] !max-w-[70vw] sm:!max-w-[70vw]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Placeholder rendering of the ICS-203 export. Layout, fonts, and pagination will differ
