...
import type { Ics215DocxBlock } from '@/features/ics215/export'

type Ics215ExportPreviewDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  title: string
  blocks: Ics215DocxBlock[]
  onExportWord: () => void
  onExportPdf: () => void
}
      ...
      <DialogContent className="!w-[70vw] !max-w-[70vw] sm:!max-w-[70vw]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Placeholder rendering of the ICS-215 export. Layout, fonts, and pagination will differ
