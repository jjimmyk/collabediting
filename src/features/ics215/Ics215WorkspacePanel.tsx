...
type Ics215WorkspacePanelProps = {
  ...
  onPatchSectionDraft: <S extends Ics215SectionId>(
    section: S,
...
export function Ics215WorkspacePanel({
  ...
  const viewVersion = (version: Ics215Version) => {
    if (!form) return
    if (!viewingPastVersion) {
      liveFormRef.current = cloneIcs215FormState(form)
    }
    setForm(cloneIcs215FormState(version.snapshot))
        ...
        <div className="flex items-center justify-end gap-2">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              <DropdownMenuLabel>Export ICS-215</DropdownMenuLabel>
              <DropdownMenuSeparator />
      ...
      >
        <DialogContent className="!w-[60vw] !max-w-[60vw] sm:!max-w-[60vw]">
          <div className="flex items-center gap-2 px-1 pb-2 text-sm font-semibold">
            ...
            {versionDialogKind === 'signed' ? 'Signed versions' : 'Version history'} — ICS-215
          </div>
