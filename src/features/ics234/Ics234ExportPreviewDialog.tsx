...
import type { Ics234DocxBlock } from '@/features/ics234/export'

type Ics234ExportPreviewDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  title: string
  blocks: Ics234DocxBlock[]
  onExportWord: () => void
  onExportPdf: () => void
}

export function Ics234ExportPreviewDialog({
  open,
  onOpenChange,
  title,
  blocks,
  onExportWord,
  onExportPdf,
}: Ics234ExportPreviewDialogProps) {
  return (
      ...
      <DialogContent className="!w-[70vw] !max-w-[70vw] sm:!max-w-[70vw]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Placeholder rendering of the ICS-234 export. Layout, fonts, and pagination will differ
