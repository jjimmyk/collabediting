...
import type { Ics209DocxBlock } from '@/features/ics209/export'

type Ics209ExportPreviewDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  title: string
  blocks: Ics209DocxBlock[]
  onExportWord: () => void
  onExportPdf: () => void
}

export function Ics209ExportPreviewDialog({
  open,
  onOpenChange,
  title,
  blocks,
  onExportWord,
  onExportPdf,
}: Ics209ExportPreviewDialogProps) {
  return (
      ...
      <DialogContent className="!w-[70vw] !max-w-[70vw] sm:!max-w-[70vw]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Placeholder rendering of the ICS-209 export. Layout, fonts, and pagination will differ in
            the final Word or PDF file.
          </DialogDescription>
        </DialogHeader>
